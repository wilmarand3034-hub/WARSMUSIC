...
<head>
    ...
    <title>WARSMUSIC — Login</title>

    <!-- Font Awesome (mismo que index.html) -->
    ...
    <style>
        ...
        * {
        ...
        /* ── FONDO ANIMADO (mismo que index.html) ── */
        .area {
            position: fixed;
            top: 0; left: 0;
        ...
        /* Círculos con distintos tamaños, posiciones y velocidades */
...
<p style="text-align:center; margin-top:14px; font-size:0.82rem; color:#aaa;">
    ¿No tienes cuenta? 
    <a href="registro.php" style="color:#00cfff; text-decoration:none;">Regístrate</a>
</p>
    <!-- CARD LOGIN -->
    <div class="login-container">
        <h2><i class="fas fa-lock" style="margin-right:8px;"></i>Acceso</h2>
...
<div class="campo">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" id="documento" name="documento" placeholder="Tu documento" required>
                </div>
            </div>
        ...
        <?php if (!empty($mensaje)): ?>
            <div class="mensaje-box <?php echo str_contains($mensaje, 'incorrectos') ? 'error' : ''; ?>">
